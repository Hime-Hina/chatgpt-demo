...
export default defineConfig({
  ...
  shortcuts: [{
    ...
    'gpt-copy-btn': 'absolute top-12px right-12px z-3 fcc border b-transparent w-8 h-8 p-2 bg-light-300 dark:bg-dark-300 transition duration-600 cursor-pointer',
